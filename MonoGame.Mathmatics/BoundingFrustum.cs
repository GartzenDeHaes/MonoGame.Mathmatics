...
namespace Microsoft.Xna.Framework
{
	...
	public sealed class BoundingFrustum : IEquatable<BoundingFrustum>
	{
		...
		public static bool operator ==(in BoundingFrustum a, in BoundingFrustum b)
		{
			if (Equals(a, null))
		...
		{
			var result = default(ContainmentType);
			this.Contains(sphere, out result);
			return result;
		}
		...
		{
			bool result;
			this.Intersects(box, out result);
			return result;
		}
		...
		public void Intersects(in BoundingBox box, out bool result)
		{
			...
			this.Contains(box, out containment);
		...
		{
			bool result;
			this.Intersects(sphere, out result);
			return result;
		}
		...
		public void Intersects(in BoundingSphere sphere, out bool result)
		{
			...
			this.Contains(sphere, out containment);
			result = containment != ContainmentType.Disjoint;
		}
		...
		public void Intersects(in Ray ray, out float? result)
		{
			...
			this.Contains(ray.Position, out ctype);
