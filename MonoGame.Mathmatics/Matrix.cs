...
namespace Microsoft.Xna.Framework
{
	...
	public struct Matrix : IEquatable<Matrix>
	{
		...
		public static Matrix CreateBillboard(in Vector3 objectPosition, in Vector3 cameraPosition,
			 Vector3 cameraUpVector, Nullable<Vector3> cameraForwardVector)
		{
			Matrix result;

			// Delegate to the other overload of the function to do the work
			CreateBillboard(objectPosition, cameraPosition, cameraUpVector, cameraForwardVector, out result);
		...
		public static void CreateBillboard(in Vector3 objectPosition, in Vector3 cameraPosition,
			 in Vector3 cameraUpVector, Vector3? cameraForwardVector, out Matrix result)
		{
			Vector3 vector;
			Vector3 vector2;
			Vector3 vector3;
		...
		{
			Matrix result;
			CreateShadow(lightDirection, plane, out result);
			return result;
		}
		...
		{
			Matrix result;
			CreateReflection(value, out result);
			return result;
		}
		...
		public static Matrix Divide(Matrix matrix1, in Matrix matrix2)
		{
		...
		public static Matrix Lerp(Matrix matrix1, in Matrix matrix2, float amount)
		{
		...
		public static Matrix Multiply(Matrix matrix1, in Matrix matrix2)
		{
