...
namespace Portland.Mathmatics
{
	...
	public struct Size : IEquatable<Size>
	{
		...
		public static Size operator /(in Size a, float b)
		{
		...
		public static Size operator /(float a, in Size b)
		{
		...
		public static implicit operator Size(in Vector3 v)
		{
			return new Size(v.X, v.Y, v.Z);
		}

		public static explicit operator Size(Tuple<float, float, float> t)
		{
		...
		/// <returns></returns>
		public static Size Min(in Size a, in Size b)
		{
		...
		/// <returns></returns>
		public static Size Negate(in Size a)
		{
			return -a;
		}
		...
		/// <returns></returns>
		public static Size Abs(in Size a)
		{
